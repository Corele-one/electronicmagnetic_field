...
axis equal
hold on
line_charge1 = plot(0, h, 'k+', 'MarkerSize', 8, 'LineWidth', 2);
line_charge2 = plot(0, -h, 'k_', 'MarkerSize', 8, 'LineWidth', 2);
title('无限长线电荷在两种介质分界面处的电势分布及电力线');
legend([line_charge1, line_charge2], {'+λ at (0,h)', '-λ at (0,-h)'}, 'Location', 'best');
